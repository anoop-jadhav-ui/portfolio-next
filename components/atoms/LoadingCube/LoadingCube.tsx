...
import { color } from "components/organisms/PortfolioModel/Model/materials";
...
export function LoadingCube(props: JSX.IntrinsicElements["group"]) {
  const { nodes } = useGLTF(
    "/assets/3dmodels/loadingCube-transformed.glb",
...
useGLTF.preload("/assets/3dmodels/loadingCube-transformed.glb");
